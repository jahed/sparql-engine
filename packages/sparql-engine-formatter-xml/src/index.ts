...
import type { PipelineStage } from "@jahed/sparql-engine/engine/pipeline/pipeline-engine.js";
import { Pipeline } from "@jahed/sparql-engine/engine/pipeline/pipeline.js";
import { Bindings } from "@jahed/sparql-engine/rdf/bindings.js";
import type { EngineTripleValue } from "@jahed/sparql-engine/types.js";
import {
  termIsBNode,
  termIsIRI,
  termIsLiteral,
