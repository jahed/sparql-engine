...
describe("SPARQL property paths: sequence paths", () => {
  ...
  it("should evaluate sequence path of length 2", (t, done) => {
    const query = `
  ...
  it("should evaluate sequence path of length 3", (t, done) => {
    const query = `
        PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
        PREFIX foaf: <http://xmlns.com/foaf/0.1/>
        PREFIX : <http://example.org/>
  ...
  it("should evaluate sequence of alternative paths", (t, done) => {
    const query = `
        PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
        PREFIX foaf: <http://xmlns.com/foaf/0.1/>
        PREFIX : <http://example.org/>
